...
import common.atmosfera_estandar as atmosfera_estandar
import common.layout_atmosfera_estandar as layout
...
class MainDialog(QDialog, layout.Ui_Dialog):
    ...
    def __init__(self, presion=101325.0, temperatura=293.0, parent=None):
        ...
        self.lineEdit_p.setText(presion)
        self.actualizarP()
        self.lineEdit_t.setText(temperatura)
        self.actualizarT()
