...
def CicloSabathe(p1,t1,Q,r_comp,variableExtra,valor):
    # punto 1
    rho1 =p1/t1/R_aire; 
    v1 = 1/rho1;
    ...
    return [punto1,punto2,punto3,punto3a,punto4], [round(Q2,1),round(Qu,1),round(W,1),round(pmed,1),round(eta,3)]
