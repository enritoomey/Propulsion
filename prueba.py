...
# Form implementation generated from reading ui file 'CicloSabatheGUI.ui'
#
# Created: Wed Mar  4 03:26:11 2015
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.r_comp = QtGui.QLineEdit(self.DatosEntrada)
        self.r_comp.setGeometry(QtCore.QRect(170, 290, 91, 20))
        self.r_comp.setObjectName("r_comp")
        ...
        self.selecDatoExtra = QtGui.QComboBox(self.DatosEntrada)
        self.selecDatoExtra.setGeometry(QtCore.QRect(20, 310, 141, 22))
        self.selecDatoExtra.setObjectName("selecDatoExtra")
        self.selecDatoExtra.addItem("")
        self.selecDatoExtra.addItem("")
        self.selecDatoExtra.addItem("")
        self.selecDatoExtra.addItem("")
        ...
        self.datoExtra = QtGui.QLineEdit(self.DatosEntrada)
        self.datoExtra.setGeometry(QtCore.QRect(170, 310, 91, 20))
        self.datoExtra.setObjectName("datoExtra")
        ...
        self.label_13.setGeometry(QtCore.QRect(20, 290, 141, 16))
        ...
        self.label_18.setGeometry(QtCore.QRect(180, 60, 141, 21))
        ...
        self.label_21.setGeometry(QtCore.QRect(180, 40, 141, 21))
        ...
        self.presionMedia.setGeometry(QtCore.QRect(280, 40, 71, 20))
        self.presionMedia.setObjectName("presionMedia")
        self.rendimiento = QtGui.QLineEdit(self.DatosSalida)
        self.rendimiento.setGeometry(QtCore.QRect(310, 60, 41, 20))
        self.rendimiento.setObjectName("rendimiento")
        self.frameGrafico = QtGui.QFrame(Dialog)
        self.frameGrafico.setGeometry(QtCore.QRect(310, 20, 361, 251))
        self.frameGrafico.setFrameShape(QtGui.QFrame.StyledPanel)
        self.frameGrafico.setFrameShadow(QtGui.QFrame.Raised)
        ...
        Dialog.setTabOrder(self.temperatura1, self.r_comp)
        Dialog.setTabOrder(self.r_comp, self.selecDatoExtra)
        Dialog.setTabOrder(self.selecDatoExtra, self.datoExtra)
        Dialog.setTabOrder(self.datoExtra, self.calor2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.r_comp.setText(QtGui.QApplication.translate("Dialog", "8", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.selecDatoExtra.setItemText(0, QtGui.QApplication.translate("Dialog", "Alpha                            =", None, QtGui.QApplication.UnicodeUTF8))
        self.selecDatoExtra.setItemText(1, QtGui.QApplication.translate("Dialog", "Beta                              =", None, QtGui.QApplication.UnicodeUTF8))
        self.selecDatoExtra.setItemText(2, QtGui.QApplication.translate("Dialog", "Presion max                =", None, QtGui.QApplication.UnicodeUTF8))
        self.selecDatoExtra.setItemText(3, QtGui.QApplication.translate("Dialog", "Temp. max                  =", None, QtGui.QApplication.UnicodeUTF8))
        self.label_11.setText(QtGui.QApplication.translate("Dialog", "Datos del ciclo:", None, QtGui.QApplication.UnicodeUTF8))
        self.datoExtra.setText(QtGui.QApplication.translate("Dialog", "2", None, QtGui.QApplication.UnicodeUTF8))
        self.temperatura1.setText(QtGui.QApplication.translate("Dialog", "293", None, QtGui.QApplication.UnicodeUTF8))
        self.label_13.setText(QtGui.QApplication.translate("Dialog", "<html><head/><body><p>Relación de compresión = </p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
